...
func (au *ArtistUpdate) SetCountry(s string) *ArtistUpdate {
	au.mutation.SetCountry(s)
	return au
}

// SetNillableCountry sets the "country" field if the given value is not nil.
func (au *ArtistUpdate) SetNillableCountry(s *string) *ArtistUpdate {
	if s != nil {
		au.SetCountry(*s)
	}
	return au
...
func (au *ArtistUpdate) ClearCountry() *ArtistUpdate {
	au.mutation.ClearCountry()
	return au
}

// SetCreatedAt sets the "created_at" field.
func (au *ArtistUpdate) SetCreatedAt(t time.Time) *ArtistUpdate {
	au.mutation.SetCreatedAt(t)
	return au
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (au *ArtistUpdate) SetNillableCreatedAt(t *time.Time) *ArtistUpdate {
	if t != nil {
		au.SetCreatedAt(*t)
	}
	return au
...
func (au *ArtistUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if au.mutation.CountryCleared() {
		_spec.ClearField(artist.FieldCountry, field.TypeString)
	}
...
// SetCountry sets the "country" field.
func (auo *ArtistUpdateOne) SetCountry(s string) *ArtistUpdateOne {
	auo.mutation.SetCountry(s)
	return auo
}

// SetNillableCountry sets the "country" field if the given value is not nil.
func (auo *ArtistUpdateOne) SetNillableCountry(s *string) *ArtistUpdateOne {
	if s != nil {
		auo.SetCountry(*s)
	}
	return auo
...
// ClearCountry clears the value of the "country" field.
func (auo *ArtistUpdateOne) ClearCountry() *ArtistUpdateOne {
	auo.mutation.ClearCountry()
	return auo
}

// SetCreatedAt sets the "created_at" field.
func (auo *ArtistUpdateOne) SetCreatedAt(t time.Time) *ArtistUpdateOne {
	auo.mutation.SetCreatedAt(t)
	return auo
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (auo *ArtistUpdateOne) SetNillableCreatedAt(t *time.Time) *ArtistUpdateOne {
	if t != nil {
		auo.SetCreatedAt(*t)
	}
	return auo
