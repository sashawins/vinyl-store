...
func (oiu *OrderItemUpdate) SetVinylID(u uuid.UUID) *OrderItemUpdate {
	oiu.mutation.SetVinylID(u)
	return oiu
}

// SetNillableVinylID sets the "vinyl_id" field if the given value is not nil.
func (oiu *OrderItemUpdate) SetNillableVinylID(u *uuid.UUID) *OrderItemUpdate {
	if u != nil {
		oiu.SetVinylID(*u)
	}
	return oiu
...
func (oiu *OrderItemUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := oiu.mutation.OrderID(); ok {
		_spec.SetField(orderitem.FieldOrderID, field.TypeUUID, value)
	}
	if value, ok := oiu.mutation.VinylID(); ok {
		_spec.SetField(orderitem.FieldVinylID, field.TypeUUID, value)
	}
...
// SetVinylID sets the "vinyl_id" field.
func (oiuo *OrderItemUpdateOne) SetVinylID(u uuid.UUID) *OrderItemUpdateOne {
	oiuo.mutation.SetVinylID(u)
	return oiuo
}

// SetNillableVinylID sets the "vinyl_id" field if the given value is not nil.
func (oiuo *OrderItemUpdateOne) SetNillableVinylID(u *uuid.UUID) *OrderItemUpdateOne {
	if u != nil {
		oiuo.SetVinylID(*u)
	}
	return oiuo
...
func (oiuo *OrderItemUpdateOne) sqlSave(ctx context.Context) (_node *OrderItem, err error) {
	...
	if value, ok := oiuo.mutation.VinylID(); ok {
		_spec.SetField(orderitem.FieldVinylID, field.TypeUUID, value)
	}
